  ...
  const handlePhoneLogin = async (e: React.FormEvent) => {
    ...
    try {
      if (!isCodeSent) {
        ...
        // Guest user bilgisini localStorage'a kaydet
  ...
  const renderAuthSelection = () => {
    return (
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 w-full max-w-4xl mx-auto">
        ...
        <Card className="bg-white/5 border-white/10 hover:bg-white/10 transition-all transform hover:scale-105 cursor-pointer" onClick={() => setAuthMode('guest')}>
          <CardHeader>
